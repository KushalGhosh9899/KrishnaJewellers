                            ...
                            <div class="featured">
                                ...
                                <div class="select-itms">
                                    <select name="select" id="select1" onchange="location = this.value;">
                                        ...
                                        <option value="categories.php?filter-product=ASC">Price : Low to High</option>
                                        <option value="categories.php?filter-product=DESC">Price : High to Low</option>                                        
                                        <option value="categories.php">Clear Filter</option>
                                    </select>                                    
                                </div>
                        </div>
                </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            ...
                            $sql = "SELECT * FROM products ORDER BY price $filterproduct";
						    $result = $conn->query($sql);
						    if($conn){
							    if ($result->num_rows > 0)
							    {
