...
?>
<head>
    <title>Bracelets - Products</title>
</head>
    <main>
                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                                                                                
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link active" href="bracelets.php">Bracelets</a>
                        ...
                        <div class="select-this d-flex">
                            <div class="featured">
                                ...
                                <select name="select" id="select1" onchange="location = this.value;">
                                        ...
                                        <option value="bracelets.php?filter-product=ASC">Price : Low to High</option>
                                        <option value="bracelets.php?filter-product=DESC">Price : High to Low</option>                                        
                                        <option value="bracelets.php">Clear Filter</option>
                                    </select>
                                </div>
                        </div>
                </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <?php
                            ...
                            $sql = "SELECT sno,pname,pimage,price,category FROM products where category='bracelets'";
                            ...
                            $sql = "SELECT * FROM products where category='bracelets' ORDER BY price $filterproduct";
						    $result = $conn->query($sql);
						    if($conn){
							    if ($result->num_rows > 0)
							    {
